...
export function LocationSelector({
  ...
  const filtered = useMemo(() => {
    ...
    if (!q) {
      // group by country, show top 5 cities of first 4 countries
  ...
  return (
    <div ref={containerRef} className="relative w-full">
      ...
      <button
        ...
        className={cn(
          'group relative w-full text-left px-4 py-3.5 bg-white border-2 border-ink-100 rounded-2xl transition-all',
        ...
        <div className="flex items-center gap-3">
          ...
          {value ? (
            <div className="flex-1 min-w-0">
              ...
              <div className="text-xs text-ink-300">{value.country}</div>
            </div>
          ) : (
      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            className="absolute z-50 left-0 right-0 mt-2 bg-white border border-ink-100 rounded-2xl shadow-float overflow-hidden"
          >
            <div className="p-3 border-b border-ink-50">
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-9 pr-3 py-2.5 bg-ink-50 border-0 rounded-xl text-sm text-ink-500 placeholder:text-ink-300 focus:outline-none focus:bg-lavender-50 focus:ring-2 focus:ring-lavender-200"
                />
              </div>
            </div>
                  ...
                  <div key={group.country}>
                    ...
                    {group.cities.map((loc) => (
                      <button
                        ...
                        className="w-full text-left px-4 py-2.5 hover:bg-lavender-50 flex items-center gap-3 transition-colors"
                      >
