...
const baseField =
  'w-full rounded-2xl border-2 border-ink-100 bg-white px-4 py-3 text-ink-500 placeholder:text-ink-300 transition-all focus:border-lavender-500 focus:outline-none focus:ring-4 focus:ring-lavender-100';
  ...
  ({ label, hint, error, className, id, ...props }, ref) => {
    ...
    return (
      <div className="space-y-1.5">
        ...
        {error && <p className="text-xs text-blush-500">{error}</p>}
      </div>
    );
  }
);
