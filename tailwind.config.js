...
module.exports = {
  ...
  theme: {
    extend: {
      colors: {
        cream: { 50: '#FEFCF8', 100: '#FAF6EF', 200: '#F3EDE0', 300: '#EBE1CC' },
        beige: { 50: '#FBF7F1', 100: '#F4ECDE', 200: '#E8D9BD', 300: '#D9C39A' },
        lavender: {
          50: '#F6F4FF', 100: '#ECE6FF', 200: '#D9CCFF', 300: '#BFA8FF',
          400: '#A083FB', 500: '#8466F0', 600: '#6B4DD8', 700: '#5538B8',
        },
        butter: {
          50: '#FFFBED', 100: '#FFF4CC', 200: '#FFE899', 300: '#FFD966',
          400: '#FFCB3D', 500: '#F4B81E', 600: '#D49906',
        },
        sky: { 50: '#F0F7FB', 100: '#DDEDF5', 200: '#B8DAEB', 300: '#8BC3DC', 400: '#5DA8C9', 500: '#3E8DB0' },
        mint: { 50: '#F1FAF6', 100: '#DCF1E6', 200: '#B3E2C9', 300: '#82CDA8', 400: '#54B387', 500: '#369A6E' },
        blush: { 50: '#FEF4F4', 100: '#FCE4E4', 200: '#F7C4C4', 300: '#EF9C9C', 400: '#E47373', 500: '#D45252' },
        ink: { 50: '#F7F5F2', 100: '#E5E0DA', 200: '#BFB6AB', 300: '#857B6F', 400: '#4F4639', 500: '#2A241D', 600: '#181410' },
      },
      fontFamily: {
      ...
      keyframes: {
        walk: { '0%': { transform: 'translateX(-10%)' }, '100%': { transform: 'translateX(110vw)' } },
        float: { '0%, 100%': { transform: 'translateY(0px)' }, '50%': { transform: 'translateY(-10px)' } },
        'cloud-drift': { '0%': { transform: 'translateX(-20%)' }, '100%': { transform: 'translateX(120%)' } },
        'wheel-spin': { '0%': { transform: 'rotate(0deg)' }, '100%': { transform: 'rotate(360deg)' } },
        'plane-pass': { '0%': { transform: 'translateX(-30%) translateY(0)' }, '50%': { transform: 'translateX(50%) translateY(-8px)' }, '100%': { transform: 'translateX(130%) translateY(0)' } },
